...
bool Railroad::checkFaults(uint8_t leverNumber, Levers levers, Signals signals) {
  ...
  switch (leverNumber) {
    ...
    case LEVER_L7:
      if (leverState == LEVER_BACK){
        if ((levers.getLever(LEVER_L4) == LEVER_FORWARD) && (levers.getLever(LEVER_L5) == LEVER_FORWARD) && (levers.getLever(LEVER_L6) == LEVER_FORWARD)) {
          return false;
        }
        else {
          return true;
    ...
    case LEVER_L8:
      if (leverState == LEVER_BACK) {
        if ((levers.getLever(LEVER_L6) == LEVER_FORWARD && levers.getLever(LEVER_L3) == LEVER_FORWARD) || (levers.getLever(LEVER_L6) == LEVER_BACK && levers.getLever(LEVER_L5) == LEVER_FORWARD && levers.getLever(LEVER_L4) == LEVER_FORWARD)) {
          return false;
        } else {
          return true;
        }
    ...
    case LEVER_L13:
      if (leverState == LEVER_BACK){
        if (levers.getLever(LEVER_L19) == LEVER_FORWARD && levers.getLever(LEVER_L20) == LEVER_FORWARD && levers.getLever(LEVER_L21) == LEVER_FORWARD && levers.getLever(LEVER_L22) == LEVER_FORWARD) {
          return false;
        } else {
          return true;
        }
    ...
    case LEVER_L14:
      if (leverState == LEVER_BACK){
        if ((levers.getLever(LEVER_L15) == LEVER_BACK && levers.getLever(LEVER_L16) == LEVER_FORWARD) || (levers.getLever(LEVER_L15) == LEVER_FORWARD && levers.getLever(LEVER_L20) == LEVER_BACK && levers.getLever(LEVER_L21) == LEVER_FORWARD && levers.getLever(LEVER_L22) == LEVER_FORWARD)) {
          return false;
        } else {
          return true;
        }
    ...
    case LEVER_L18:
      if (leverState == LEVER_BACK){
        if (levers.getLever(LEVER_L19) == LEVER_BACK && levers.getLever(LEVER_L20) == LEVER_FORWARD && levers.getLever(LEVER_L21) == LEVER_FORWARD && levers.getLever(LEVER_L22) == LEVER_FORWARD) {
          return false;
        } else {
          return true;
        }
    ...
    case LEVER_L19:
      if (leverState == LEVER_BACK){
        if (levers.getLever(LEVER_L13) == LEVER_FORWARD && levers.getLever(LEVER_L20) == LEVER_FORWARD && levers.getLever(LEVER_L21) == LEVER_FORWARD && levers.getLever(LEVER_L22) == LEVER_FORWARD) {
          return false;
        } else {
          return true;
        }
